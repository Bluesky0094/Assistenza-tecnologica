...
window.TRANSLATIONS.it = {
  ...
  faq_q9: "Posso richiedere un sito web semplice?",
  faq_a9:
    "Sì, realizzo siti vetrina essenziali con contatti e informazioni principali.",
  ...
  tools_subtitle:
    "Crea credenziali sicure, controlla password esistenti, genera nomi utente puliti e codici QR in pochi secondi.",
  tool_mode: "Modalità",
  ...
  checker_subtitle: "Verifica la robustezza di una password e ricevi consigli pratici.",
