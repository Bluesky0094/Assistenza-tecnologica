...
window.TRANSLATIONS.it = {
  ...
  tool_credential_title: "Generatore password o username",
  tool_qr_title: "Generatore QR code",
  tool_qr_subtitle: "Inserisci un link o un testo breve e crea subito un QR code da condividere.",
  tool_qr_input_label: "Testo o link",
  tool_qr_input_placeholder: "https://esempio.it",
  tool_qr_size: "Dimensione",
  tool_qr_generate: "Crea QR",
  tool_qr_download: "Scarica PNG",
  tool_qr_hint: "Inserisci un testo o link valido.",
  tool_qr_image_alt: "QR code generato",
